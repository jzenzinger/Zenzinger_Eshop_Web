...
namespace Zenzinger_Eshop_Web.Models.ApplicationServices.Implementation
{
    public class SecurityIdentityApplicationService : ISecurityApplicationService
    {
        ...
        {
            var result = await sigInManager.PasswordSignInAsync(vm.Username, vm.Password, vm.LoginFailed, true);
